...
OUTPUT_ARCH(riscv)
ENTRY(_start)
SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib32/ilp32d"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib32"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib3232/ilp32d"); SEARCH_DIR("=/usr/local/lib32/ilp32d"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32/ilp32d"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32/ilp32d"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
