...
OUTPUT_ARCH(riscv)
ENTRY(_start)
SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib64/lp64d"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib64"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib6464/lp64d"); SEARCH_DIR("=/usr/local/lib64/lp64d"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64/lp64d"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64/lp64d"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/usr/riscv64-alpine-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
